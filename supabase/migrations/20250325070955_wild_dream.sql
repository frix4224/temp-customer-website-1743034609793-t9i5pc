/*
  # Create Driver Package Management Schema

  1. Changes
    - Create tables for driver package management
    - Add proper constraints and indexes
    - Add RLS policies
  
  2. Security
    - Enable RLS
    - Add policies for drivers
...
DROP POLICY IF EXISTS "Drivers can view their assigned packages" ON driver_packages;
DROP POLICY IF EXISTS "Service role can manage all packages" ON driver_packages;
DROP POLICY IF EXISTS "Drivers can view their package orders" ON package_orders;
DROP POLICY IF EXISTS "Service role can manage all package orders" ON package_orders;
